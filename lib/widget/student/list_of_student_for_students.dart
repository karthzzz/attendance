...
class ListOfStudentForStudents extends StatefulWidget {
  const ListOfStudentForStudents({
    super.key,
  ...
  @override
  State<ListOfStudentForStudents> createState() => _ListOfStudentForStudentsState();
}

class _ListOfStudentForStudentsState extends State<ListOfStudentForStudents> {
